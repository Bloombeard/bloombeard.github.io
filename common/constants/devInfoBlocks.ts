...
export const devInfoBlocks: TDevInfoBlock = {
    about: {
        header: 'About',
        sections: [{
            bodyText: "Forrest is a highly motivated software engineer looking to expand beyond the front end, and seeking opportunities to work in more impactful corners of tech and education. In his off hours, Forrest can usually be found writing stories, baking, or saying hello to other people's dogs.",
        }],
    },
    skills: {
        header: 'Skills',
